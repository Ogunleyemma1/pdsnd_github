...
def choice(prompt, choices=('y', 'n')):
    ...
    while True:
        ...
        # stop the program if the input is end
        if choice == 'end':
            raise SystemExit
        #for input with only one name, triggers
        elif ',' not in choice:
        ...
        prompt = ("\n Sorry, I did not get that please retry:\n>")

    return choice


def get_filters():
    """Ask user to define city(ies) and filters, month(s) and weekday(s).
    Returns:
    ...
    while True:
        ...
        verification = choice("\nPlease verify that you would like to apply "
...
def load_data(city, month, day):
    """Load  the specified filters data of city(ies), month(s) and
    ...
    # filter data according to the selected city filters
    ...
    # create columns displaying statistics
...
def station_stats(df):
    ...
    # display start station that are most commonly used
    ...
    # display end station that are most commonly used
